...
def visualize(_current_w1, _current_w2, _x1, _x2, _y_tar, title):
    ...
    _current_loss = loss_function(float(_current_w1), float(_current_w2), _x1, _x2, _y_tar)

    if title == "Fehlergebirge - Start":
        print('Fehlerwert Start: ' + str(round(_current_loss, 1)) + '\r\n')

    ax.plot(_current_w1, _current_w2, _current_loss, marker="o",
...
if __name__ == '__main__':
    ...
    current_w1, current_w2, current_loss = visualize(_current_w1=w1, _current_w2=w2, _x1=x1, _x2=x2, _y_tar=y_tar,
